namespace BugLite.Library.Gui.Controls
{
	partial class IssueControl
	{
		...
		private void InitializeComponent()
		{
			...
			this._tlpUserControl.Controls.Add(this._cxSeverity, 1, 3);
			this._tlpUserControl.Controls.Add(this.label7, 0, 4);
			this._tlpUserControl.Controls.Add(this.label6, 0, 3);
			...
			this._tlpUserControl.Controls.Add(this.label5, 0, 6);
			this._tlpUserControl.Controls.Add(this._lblIssue, 1, 0);
			this._tlpUserControl.Controls.Add(this._cxStatus, 1, 2);
			this._tlpUserControl.Controls.Add(this._txTitle, 1, 5);
			this._tlpUserControl.Controls.Add(this._txDescription, 1, 6);
			...
			this._tlpUserControl.RowCount = 7;
			...
			this._cxPriority.Location = new Point(131, 115);
			...
			this._cxSeverity.Location = new Point(131, 87);
			...
			this.label7.Location = new Point(44, 112);
			...
			this.label6.Location = new Point(44, 84);
			...
			this._lblProject.Size = new Size(425, 28);
			...
			this.label4.Location = new Point(71, 140);
			...
			this.label5.Location = new Point(17, 168);
			this.label5.Name = "label5";
			this.label5.Size = new Size(108, 272);
			...
			this._txTitle.Location = new Point(131, 143);
			...
			this._txDescription.Location = new Point(131, 171);
			this._txDescription.Multiline = true;
			this._txDescription.Name = "_txDescription";
			this._txDescription.Size = new Size(425, 266);
